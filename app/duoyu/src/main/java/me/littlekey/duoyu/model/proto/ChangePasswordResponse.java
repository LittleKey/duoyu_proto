...
// Source file: business/user.proto at 82:1
...
public final class ChangePasswordResponse extends Message<ChangePasswordResponse, ChangePasswordResponse.Builder> {
  ...
  @WireField(
      tag = 2,
      adapter = "me.littlekey.duoyu.model.proto.ChangePasswordResponse$Errno#ADAPTER"
  )
  public final Errno errno;

  public ChangePasswordResponse(Boolean success, Errno errno) {
    this(success, errno, ByteString.EMPTY);
  }

  public ChangePasswordResponse(Boolean success, Errno errno, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof ChangePasswordResponse)) return false;
    ChangePasswordResponse o = (ChangePasswordResponse) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "ChangePasswordResponse{").append('}').toString();
  }
  ...
  public static final class Builder extends Message.Builder<ChangePasswordResponse, Builder> {
    ...
    public ChangePasswordResponse build() {
      return new ChangePasswordResponse(success, errno, super.buildUnknownFields());
    }
  }
  ...
  public enum Errno implements WireEnum {
    ...
    public static Errno fromValue(int value) {
      switch (value) {
        ...
        case 1: return INVALID_EMAIL_CODE;
        default: return null;
      }
    }
  ...
  private static final class ProtoAdapter_ChangePasswordResponse extends ProtoAdapter<ChangePasswordResponse> {
    ProtoAdapter_ChangePasswordResponse() {
      super(FieldEncoding.LENGTH_DELIMITED, ChangePasswordResponse.class);
    }

    @Override
    public int encodedSize(ChangePasswordResponse value) {
    ...
    @Override
    public void encode(ProtoWriter writer, ChangePasswordResponse value) throws IOException {
    ...
    @Override
    public ChangePasswordResponse decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public ChangePasswordResponse redact(ChangePasswordResponse value) {
