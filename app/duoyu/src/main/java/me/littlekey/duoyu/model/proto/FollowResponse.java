...
// Source file: business/user.proto at 34:1
...
public final class FollowResponse extends Message<FollowResponse, FollowResponse.Builder> {
  ...
  @WireField(
      tag = 3,
      adapter = "me.littlekey.duoyu.model.proto.FollowResponse$Errno#ADAPTER"
  )
  public final Errno errno;

  public FollowResponse(Boolean success, User.Relationship relationship, Errno errno) {
    this(success, relationship, errno, ByteString.EMPTY);
  }

  public FollowResponse(Boolean success, User.Relationship relationship, Errno errno, ByteString unknownFields) {
  ...
  public static final class Builder extends Message.Builder<FollowResponse, Builder> {
    ...
    public FollowResponse build() {
      return new FollowResponse(success, relationship, errno, super.buildUnknownFields());
    }
  }
  ...
  public enum Errno implements WireEnum {
    ...
    public static Errno fromValue(int value) {
      switch (value) {
        ...
        case 1: return ALREADY_FOLLOWING;
        default: return null;
      }
    }
